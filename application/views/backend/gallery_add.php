            ...
            <form action="">
                <div class="row g-4">
                    <div class="col-lg-6 col-md-6">
                        <p class="mb-2">Gallery Image <span class="ms-2 text-danger">*</span></p>
                        <input id="product_img" name="product_img" type="file" placeholder="Choose Gallery Image" class="border rounded-3 px-4 py-2 w-100">
                    </div>
                    <div class="col-12">
