...
<div class="container-fluid hero-header bg-light py-5 mb-5">
    <div class="container py-5 mt-lg-3">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                <p class="text-primary text-uppercase mb-2 animated slideInDown">Welcome To SV Agro</p>
                ...
                <div class="d-flex align-items-center pt-4 animated slideInDown">
                    <a href="<?php echo base_url(); ?>contactus" class="btn btn-primary py-3 px-5 me-5">Contact Us</a>
            ...
            <div class="col-lg-6 animated fadeIn">
                <div class="row g-3">
                    <div class="col-6 text-end">
                        <div class="bg-white p-3 rounded-3 w-100 mb-3">
                            <img class="img-fluid rounded-3 w-100" src="<?php echo base_url(); ?>themes/img/hero-1.jpg" alt="">
                        </div>
                        <div class="bg-white p-3 rounded-3 ms-auto w-50">
                            <img class="img-fluid rounded-3 w-100" src="<?php echo base_url(); ?>themes/img/hero-3.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="bg-white p-3 rounded-3 w-50 mb-3">
                            <img class="img-fluid rounded-3 w-100" src="<?php echo base_url(); ?>themes/img/hero-4.jpg" alt="">
                        </div>
                        <div class="bg-white p-3 rounded-3 w-100">
                            <img class="img-fluid rounded-3 w-100" src="<?php echo base_url(); ?>themes/img/hero-2.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-5">
                ...
                <div class="row g-3 img-twice position-relative h-100">
                    <div class="col-6">
                        <div class="bg-light p-3 rounded-3">
                            <img class="img-fluid rounded-3" src="<?php echo base_url(); ?>themes/img/about-1.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-6 align-self-end">
                        <div class="bg-light p-3 rounded-3">
                            <img class="img-fluid rounded-3" src="<?php echo base_url(); ?>themes/img/about-2.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="h-100">
                    ...
                    <a class="btn btn-primary py-3 px-5" href="<?php echo base_url(); ?>aboutus">Read More</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row g-3">
            <div class="col-lg-4 col-md-6 pt-lg-5 wow fadeInUp" data-wow-delay="0.1s">
                <div class="fact-item bg-light text-center h-100 p-5 rounded-3">
                    ...
                    <div class="service-item d-flex flex-column bg-white p-3 pb-0 rounded-3">
                        <div class="position-relative">
                            ...
                            <div class="service-overlay">
                                <div class="btn btn-lg-square"></div>
                            </div>
                        </div>
...
<div class="container-xxl py-5">
    <div class="container">
        ...
        <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
            <div class="testimonial-item bg-white p-4 rounded-3">
                <div class="d-flex align-items-center mb-4">
                    <img class="flex-shrink-0 rounded-circle border p-1" src="<?php echo base_url(); ?>themes/img/testimonial-1.jpg" alt="">
                    <div class="ms-4">
            ...
            <div class="testimonial-item bg-white p-4 rounded-3">
                <div class="d-flex align-items-center mb-4">
                    <img class="flex-shrink-0 rounded-circle border p-1" src="<?php echo base_url(); ?>themes/img/testimonial-2.jpg" alt="">
                    <div class="ms-4">
                        <h5 class="mb-1">Client Name</h5>
                        <span>Profession</span>
                    </div>
            ...
            <div class="testimonial-item bg-white p-4 rounded-3">
                <div class="d-flex align-items-center mb-4">
                    <img class="flex-shrink-0 rounded-circle border p-1" src="<?php echo base_url(); ?>themes/img/testimonial-3.jpg" alt="">
                    <div class="ms-4">
                        <h5 class="mb-1">Client Name</h5>
                        <span>Profession</span>
                    </div>
            ...
            <div class="testimonial-item bg-white p-4 rounded-3">
                <div class="d-flex align-items-center mb-4">
                    <img class="flex-shrink-0 rounded-circle border p-1" src="<?php echo base_url(); ?>themes/img/testimonial-4.jpg" alt="">
                    <div class="ms-4">
                        <h5 class="mb-1">Client Name</h5>
                        <span>Profession</span>
                    </div>
